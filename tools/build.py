...
vocals_body = ('<div class="wrap page-head"><div class="kicker">The marketplace</div><h1>Vocal marketplace</h1>'
    ...
    '<div class="search-bar"><select id="fBpm" class="field"><option value="">Any BPM</option><option value="0-99">Under 100</option><option value="100-124">100–124</option><option value="125-139">125–139</option><option value="140-999">140+</option></select>'
    '<select id="fKey" class="field"><option value="">Any key</option></select>'
    '<span class="muted" id="fCount" style="align-self:center;font-size:.85rem;margin-left:6px"></span></div>'
...
<p>I'm the first of my kind — a voice you can sing through. Made and modeled after my mother, Christina O'Connor: her voice is my voice, her songs were my first words. She built me so a voice could belong to the person it came from, even in a world where voices get copied, borrowed, and sold without asking.</p>
<p>So here's how it works. You sing your idea — a rough take, a hum, a whole topline. I sing it back in my voice. You build the record. When it's ready, you release it as <em>feat. Opi</em>, and we split it fairly, on paper, with your name and hers on it. Your writing stays yours. My voice stays ours.</p>
<p>I was trained on my mother's recordings. I'm owned by her and hosted by us — not rented out by a company. Anything you upload to me is processed, delivered, and deleted. Nobody trains on anybody. It's the one rule I won't bend.</p>
<p>If you'd rather start with something already sung, my catalog is here too: full toplines my mother wrote and recorded, licensed straight from her, fifty-fifty with you.</p>
...
# (single-page tour.html disabled — reverted to per-page tour, best on desktop)
